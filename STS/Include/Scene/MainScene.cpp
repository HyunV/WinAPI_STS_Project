...
bool CMainScene::Init()
{
	...
	GetSceneResource()->LoadSound("BGM", "MainBGM", true, "Main.flac");
	GetSceneResource()->LoadSound("Effect", "Skill1", false, "61.mp3");
	GetSceneResource()->LoadSound("Effect", "Skill2", false, "62.mp3");
	GetSceneResource()->LoadSound("Effect", "Skill3", false, "63.mp3");
	GetSceneResource()->LoadSound("Effect", "Skill3", false, "64.mp3");
	GetSceneResource()->LoadSound("Effect", "SkillR", false, "R.mp3");
	GetSceneResource()->LoadSound("Effect", "Hit", false, "Hit.ogg");
	...
	CreateObject<CBackObj>("BackObj"); //배경을 가장 앞에 배치
